...
| ChatGPT/Codex subscription with explicit PI runtime  | `openai/gpt-5.5` plus `agentRuntime.id: "pi"`           | Opt-in compatibility route. Select an `openai-codex` auth profile.    |
